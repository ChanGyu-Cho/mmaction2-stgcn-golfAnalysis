...
ann_file = r"E:\golfDataset\dataset\crop_pkl\combined_5class.pkl" # 5-class 데이터셋으로 가정
test_ann_file = r"D:\golfDataset\dataset\crop_pkl\combined_5class_test.pkl" # 5-class 데이터셋으로 가정
EPOCH = MAX_EPOCHS
clip_len = 100
